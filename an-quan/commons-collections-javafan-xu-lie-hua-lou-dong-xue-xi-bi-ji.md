# Commons Collections Java反序列化漏洞学习笔记
...
方法用于反序列化。下面是将字符串对象先进行序列化，存储到本地文件，然后再通过反序列化进行恢复的样例代码：![](../.gitbook/assets/apache-java1.png)**序列号之后的数据解析**

数据开头为“AC ED 00 05”，数据内容包含了包名与类名、类中包含的变量名称、类型及变量的值。![](../.gitbook/assets/apache-java2.png)这里需要注意的是，`ac ed 00 05`是java序列化内容的特征，如果经过base64编码，那么相对应的是`rO0AB`：

![](../.gitbook/assets/apache-java3.png)
...
![](../.gitbook/assets/apache-java4.png)
...
![](../.gitbook/assets/apache-java5.png)
...
![](../.gitbook/assets/apache-java6.png)
...
![](../.gitbook/assets/apache-java7.png)

![](../.gitbook/assets/apache-java8.png)
...
![](../.gitbook/assets/apache-java12.png)
...
![](../.gitbook/assets/apache-java13.png)

然后依次类推：

![](../.gitbook/assets/apache-java14.png)

最后：

![](../.gitbook/assets/apache-java15.png)
...
![](../.gitbook/assets/apache-java16.png)
...
![](../.gitbook/assets/apache-java17.png)

AnnotationInvocationHandler的readObject\(\)函数中对memberValues的每一项调用了setValue\(\)函数，如下所示：![](../.gitbook/assets/apache-java18.png)**因为setValue\(\)函数最终会触发checkSetValue\(\)函数：**

![](../.gitbook/assets/apache-java-21.png)

因此我们只需要使用前面构造的outmap来构造AnnotationInvocationHandler，进行序列化，当触发readObject\(\)反序列化的时候，就能实现命令执行：

![](../.gitbook/assets/apache-java20.png)

接下来就只需要序列化该对象：

![](../.gitbook/assets/apache-java21.png)

当反序列化该对象，触发readObject\(\)方法，就会导致命令执行：

![](../.gitbook/assets/apache-java22.png)

Server端接收到恶意请求后的处理流程：![](../.gitbook/assets/apachecommon-fan-xu-lie-hua.jpg)最终POP链执行过程
